package com.axiomsl.properties.framework.mappers.simple.restrictions;

import com.axiomsl.properties.framework.mappers.simple.ObjectElement;
...
public class RestrictProvider<T> {
    ...
    public static void main(String[] args) {
        RestrictProvider<Integer> restrictProvider = new RestrictProvider<>(new ObjectElement<Integer>() {
            @Override
            public <U extends Annotation> U getAnnotation(Class<U> annotationType) {
                try {
                    return RestrictProvider.class.getDeclaredMethod("main", String[].class).getAnnotation(annotationType);
        ...
        System.out.println(restrictProvider.applyAllTo(-25));
    }
}
